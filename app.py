...
ALL_JACKETS = [str("jackets/") + file for file in os.listdir("jackets/") if not file.startswith('.')]
ALL_BAGS = [str("bags/") + file for file in os.listdir("bags/") if not file.startswith('.')]
ALL_JEWELRY = [str("jewelry/") + file for file in os.listdir("jewelry/") if not file.startswith('.')]
ALL_DRESSES = [str("dresses/") + file for file in os.listdir("dresses/") if not file.startswith('.')]
